  ...
  return (
    <>
      ...
      <div className="bg-cover bg-center flex items-center justify-center lg:pt-40 pb-40" style={{ backgroundImage: "url('./images/Group 175.png')" }}>
        <div className='container'>
          <div className='text-center'>
            <h1 className='text-3xl font-bold mt-20 sm:mt-10 md:text-4xl '>Your Trusted Partner in  <br /> <span className="text-[#086FB1]">Real Estate</span></h1>
      ...
      <div className='container mx-auto mt-5'>
        <h1 className='text-3xl font-bold mt-20 sm:mt-10 md:text-4xl text-center'>Begin Your Real Estate Journey Here</h1>
        <div className='mt-5'>
