...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className='container mx-auto p-4 '>
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="flex justify-center ">
            <div className="">
              <h1 className='text-3xl font-bold mt-10 md:text-4xl'>Why Investors Choose <br /> Luminara ss <span className="text-[#086FB1]">First ?</span></h1>
      ...
      {/* section 2 */}
      <div className='container mx-auto p-4'>
        <h1 className="text-2xl md:text-3xl font-bold mt-10">Featured Residences</h1>
      ...
      <div className="min-h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('./images/Group 173.png')" }}>
        ...
        <div className=' container text-center text-white md:p-40 p-10'>
          <h1 className='text-2xl sm:text-3xl md:text-3xl font-bold mt-10'>Why Investors Choose Luminara First ?</h1>
      ...
      <div className='container mx-auto p-4'>
        <div>
          <h1 className='text-2xl sm:text-3xl md:text-3xl font-bold mt-10'>Our Portfolio</h1>
          <p className='text-[#464545]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever </p>
        </div>
        <div className='grid grid-cols-1 justify-items-center sm:justify-normal sm:grid-cols-2 gap-2 lg:grid-cols-4 mt-3'>
          <Propertycard
      ...
      <div className='container-fluid'>
        <div className='container mx-auto p-4'>
          <h1 className='text-2xl sm:text-3xl md:text-3xl font-bold '>Testimonials</h1>
          <p className='text-[#464545]'>At Luminara, we go beyond traditional real estate — we create lifestyle-driven investments that combine lasting value with everyday luxury. With over 15 years of experience and more than 120 successfully completed projects, we’ve earned the trust of investors, homeowners, and communities alike. From stunning cabanas to premium apartments and curated land packages, every project is designed to deliver exceptional returns while enriching the way you live.</p>
        </div>
        <TestimonialSlider />
      </div>
      ...
      {/* Section 9 */}
      <div className='container mx-auto p-4'>
        <h1 className='text-2xl sm:text-3xl md:text-3xl font-bold mt-10'>News</h1>
        <p className='text-[#464545]'>At Luminara, we go beyond traditional real estate — we create lifestyle-driven investments that combine lasting value with everyday luxury. With over 15 years of experience and more than 120 successfully completed projects, we’ve earned the trust of investors, homeowners, and communities alike. From stunning cabanas to premium apartments and curated land packages, every project is designed to deliver exceptional returns while enriching the way you live.</p>
